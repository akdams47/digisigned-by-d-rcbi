    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-2xl mx-auto">
        <p className="text-lg mb-6">
          Becoming a member of the Rotary Club of Bonny Island offers you the opportunity to make a difference in your community and connect with like-minded professionals. As a Rotarian, you will be part of a global network dedicated to creating positive change.
        </p>
