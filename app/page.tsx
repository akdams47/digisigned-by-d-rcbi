...
import { ArrowRight, Landmark, Heart, Leaf, Book, Stethoscope } from 'lucide-react'
    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-cover bg-center text-white py-24 md:py-36 animate-fade-in-up" style={{ backgroundImage: "url('/images/snapmembersplus.jpg')" }}>
        ...
        <div className="container relative z-10 mx-auto flex justify-end animate-fade-in-up">
          <div className="bg-[#54565a] bg-opacity-90 rounded-lg p-4 md:p-6 w-full md:w-1/2 lg:w-1/3"> {/* Changed background color, reduced width, and padding */}
            <div className="p-4"> {/* Added inner padding */}
              <h1 className="text-3xl md:text-4xl font-bold mb-4 leading-tight text-rotary-gold animate-pulse"> {/* Reduced margin */}
