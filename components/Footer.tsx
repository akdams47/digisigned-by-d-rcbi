      ...
      <div className="container py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="bg-gray-300 p-4 rounded">
            ...
            <p className="text-sm text-gray-700">Chartered in 2020</p>
            <Image 
          ...
          <div className="bg-[#b9d9eb] p-4 rounded">
            ...
            <address className="text-sm text-gray-700 not-italic">
              <p>Atlantic Sterling Hotel,

              After Finima Military Checkpoint,
              Bonny Island
              </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-600 text-center text-sm text-gray-900">
